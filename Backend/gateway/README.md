...
#### Related Service
📖 **User Service**: [User Registration Documentation](../user_service/README.md#user-registration)
...
#### Related Service
📖 **User Service**: [User Login Documentation](../user_service/README.md#user-login)
...
#### Related Service
📖 **User Service**: [Password Update Documentation](../user_service/README.md#update-password)
...
#### Related Service
📖 **User Service**: [Account Deletion Documentation](../user_service/README.md#delete-account)
  ...
  "jsonCv": [
    {
      ...
      "education": ["B.Tech in Computer Science – ABC University (2016-2020)"],
...
#### Related Service
📖 **ETL Service**: [CV Upload Documentation](../etl_service/README.md#upload-and-process-cvs)
...
#### Related Service
📖 **User Service**: [Logs Endpoint Documentation](../user_service/README.md#logs-endpoint)
...
#### Related Service
📖 **ETL Service**: [Logs Endpoint Documentation](../etl_service/README.md#view-service-logs)
...
### 2. User Login
```
Client → Gateway → User Service → Verify credentials → Generate JWT
         ↓
      Returns JWT token
```
...
**⚠️ Production Recommendation**: Restrict `allow_origins` to specific domains
...
3. **Request Validation Errors**
   - Empty file uploads → 400 Bad Request
   - Missing required fields → 422 Unprocessable Entity

### Error Propagation

Gateway forwards status codes and error messages from upstream services:
- User Service errors → Returned as-is to client
- ETL Service errors → Returned as-is to client
- Network errors → Translated to appropriate HTTP status codes
